...
export const MODEL_CATALOG: Record<ModelType, ModelInfo[]> = {
  text: [
    ...
    { id: "claude-opus-4-5", name: "Claude Opus 4.5", provider: "Anthropic", type: "text", inputPrice: 1.75, outputPrice: 8.75, description: "Opus classique fiable" },
    ...
    { id: "claude-sonnet-4-6", name: "Claude Sonnet 4.6", provider: "Anthropic", type: "text", inputPrice: 1.05, outputPrice: 5.25, description: "Bon équilibre vitesse/qualité" },
  ...
  video: [
    ...
    { id: "kling-3-0", name: "Kling 3.0", provider: "Kuaishou", type: "video", pricePerSec: 0.070, description: "Multi-shot, référencement d'éléments" },
    { id: "kling-v3-turbo", name: "Kling V3 Turbo", provider: "Kuaishou", type: "video", pricePerReq: 0.210, description: "Kling rapide, économique (2.5 Turbo)" },
    ...
    { id: "seedance-2-fast", name: "Seedance 2.0 Fast", provider: "ByteDance", type: "video", pricePerReq: 0.045, description: "Génération rapide ByteDance" },
    { id: "seedance-2-mini", name: "Seedance 2.0 Mini", provider: "ByteDance", type: "video", pricePerReq: 0.045, description: "Mini, idéal pour tests" },
