...
export const MODEL_CATALOG: Record<ModelType, ModelInfo[]> = {
  text: [
    ...
    { id: "claude-opus-4-5", name: "Claude Opus 4.5", provider: "Anthropic", type: "text", inputPrice: 2.00, outputPrice: 10.00, description: "Opus classique fiable" },
    { id: "claude-sonnet-5", name: "Claude Sonnet 5", provider: "Anthropic", type: "text", inputPrice: 1.10, outputPrice: 5.50, description: "Dernier Sonnet, raisonnement renforcé" },
    ...
    { id: "gemini-3-5-flash", name: "Gemini 3.5 Flash", provider: "Google", type: "text", inputPrice: 0.10, outputPrice: 0.60, description: "Flash nouvelle génération, ultra-rapide" },
  ...
  image: [
    ...
    { id: "imagen-4", name: "Imagen 4", provider: "Google", type: "image", pricePerImg: 0.030, description: "Dernier modèle Google" },
    ...
    { id: "flux-2-flex", name: "Flux 2 Flex", provider: "Black Forest Labs", type: "image", pricePerImg: 0.015, description: "Flux économique, génération rapide" },
    ...
    { id: "seedream-5-lite", name: "Seedream 5.0 Lite", provider: "ByteDance", type: "image", pricePerImg: 0.025, description: "Seedream léger et rapide" },
    ...
    { id: "ideogram-v3", name: "Ideogram V3", provider: "Ideogram", type: "image", pricePerImg: 0.035, description: "Typographie et design précis" },
    { id: "qwen-t2i", name: "Qwen T2I", provider: "Alibaba", type: "image", pricePerImg: 0.015, description: "Multilingue, texte→image" },
    { id: "qwen-i2i", name: "Qwen I2I", provider: "Alibaba", type: "image", pricePerImg: 0.018, description: "Édition image Alibaba" },
    { id: "qwen2-t2i", name: "Qwen2 T2I", provider: "Alibaba", type: "image", pricePerImg: 0.020, description: "Nouvelle génération Qwen" },
    ...
    { id: "wan-2-7-image", name: "Wan 2.7 Image", provider: "Wan", type: "image", pricePerImg: 0.020, description: "Génération et édition Wan" },
    { id: "wan-2-7-image-pro", name: "Wan 2.7 Image Pro", provider: "Wan", type: "image", pricePerImg: 0.035, description: "Wan Pro haute qualité" },
  ],
  audio: [
  ...
  video: [
    ...
    { id: "kling-v2-1-standard", name: "Kling V2.1 Standard", provider: "Kuaishou", type: "video", pricePerReq: 0.15, description: "Kling standard économique" },
    { id: "kling-2-6", name: "Kling 2.6", provider: "Kuaishou", type: "video", pricePerReq: 0.35, description: "Kling 2.6, contrôle de mouvement" },
    { id: "seedance-2-0", name: "Seedance 2.0", provider: "ByteDance", type: "video", pricePerSec: 0.057, description: "Réaliste, avatars virtuels" },
    { id: "seedance-2-fast", name: "Seedance 2.0 Fast", provider: "ByteDance", type: "video", pricePerReq: 0.20, description: "Génération rapide ByteDance" },
    { id: "seedance-2-mini", name: "Seedance 2.0 Mini", provider: "ByteDance", type: "video", pricePerReq: 0.10, description: "Mini, idéal pour tests" },
    ...
    { id: "grok-imagine-v1-5", name: "Grok Imagine 1.5 Preview", provider: "xAI", type: "video", pricePerReq: 0.50, description: "Dernière preview Grok vidéo" },
    ...
    { id: "hailuo-standard", name: "Hailuo Standard", provider: "MiniMax", type: "video", pricePerReq: 0.100, description: "Hailuo standard économique" },
    { id: "wan-2-6-t2v", name: "Wan 2.6 T2V", provider: "Wan", type: "video", pricePerReq: 0.20, description: "Texte→Vidéo Wan 2.6" },
    { id: "wan-2-6-i2v", name: "Wan 2.6 I2V", provider: "Wan", type: "video", pricePerReq: 0.25, description: "Image→Vidéo Wan 2.6" },
    { id: "wan-2-7-t2v", name: "Wan 2.7 T2V", provider: "Wan", type: "video", pricePerReq: 0.30, description: "Dernier Wan texte→vidéo" },
    { id: "wan-2-7-i2v", name: "Wan 2.7 I2V", provider: "Wan", type: "video", pricePerReq: 0.35, description: "Dernier Wan image→vidéo" },
    ...
    { id: "infinitetalk", name: "InfiniteTalk", provider: "MeiGen AI", type: "video", pricePerReq: 0.10, description: "Avatars parlants à partir d'audio" },
    { id: "omnihuman-1-5", name: "OmniHuman 1.5", provider: "OmniHuman", type: "video", pricePerReq: 0.40, description: "Génération de personnages humains" },
  ],
};
