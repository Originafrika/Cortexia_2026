...
interface NeonSocialButtonsProps {
...
export function NeonSocialButtons({ userType, companyData, developerData }: NeonSocialButtonsProps) {
      ...
      >
        ...
        <div className="relative flex items-center justify-center gap-3">
          ...
          <span className="text-white">
            {isLoading === 'google' ? 'Connexion...' : 'Continuer avec Google'}
          </span>
        </div>
      </button>
