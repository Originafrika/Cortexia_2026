 ...
 * ✅ OPTIMIZED: Full BDS colors compliance
 */
    ...
    <div className="flex items-center gap-3 overflow-x-auto pb-2 scrollbar-hide">
      ...
      {categories.map(category => {
        const badgeColors = {
          ...
          MIXED: 'bg-[var(--coconut-husk)]/20 text-[var(--coconut-husk)] border-[var(--coconut-husk)]/30',
          PAID: 'bg-[var(--coconut-shell)]/20 text-[var(--coconut-shell)] border-[var(--coconut-shell)]/30',
        };
          ...
          <button
            ...
            className={`
              ...
              ${selected === category.id
                ? 'bg-[var(--coconut-palm)] text-white shadow-lg scale-105'
                : 'bg-white/5 text-[var(--coconut-husk)] hover:bg-white/10 border border-white/10 hover:scale-105'
              }
            `}
          >
